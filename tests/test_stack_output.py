...
from resolver.stack_output import StackOutput, StackOutputBase


class TestStackOutputResolver(object):

    @patch(
        "resolver.stack_output.StackOutput._get_output_value"
    )
...
class TestStackOutputBaseResolver(object):
    ...
    @patch(
        "resolver.stack_output.StackOutputBase._get_stack_outputs"
    )
